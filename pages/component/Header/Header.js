...
/*
  Header component to display header information.
  @param {Object} props - component properties.
  @param {string} props.name - The name to be displayed in the header.
  @param {function} props.setDisplay - The function to handle the display state.
  @returns {JSX} - Returns the header component.
 */
